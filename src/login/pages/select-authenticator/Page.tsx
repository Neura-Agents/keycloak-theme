...
const getAuthenticatorIcon = (authSelection: {
    ...
    if (
        ...
        return <HugeiconsIcon icon={FingerPrintIcon} className="w-5 h-5" />;
    }
    ...
    if (
        ...
        return <HugeiconsIcon icon={SecurityIcon} className="w-5 h-5" />;
    }
    ...
    if (
        ...
        return <HugeiconsIcon icon={GlobalIcon} className="w-5 h-5" />;
    }
